...
public class Exercise1 {
    ...
    public static void main(String[] args) {
        ...
        // TODO: Write code here
        System.out.println("Print All Numbers Less Than 5");
        ...
        System.out.println(StreamSources.intNumbersStream().filter(e -> e > 5)
                .findFirst().orElse(-1));
        ...
        System.out.println("Better way of Print first names in userStream for users that have IDs from number stream");
